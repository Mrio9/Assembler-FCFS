...
public class Pass2 {
	...
	public static void main(String[] args) {
		...
		try {
			pass2.generateCode("C:\\Users\\Sairaj Y\\Downloads\\New\\IC.txt");
		} catch (Exception e) {
	...
	public void readtables()
	{
		...
		try
		{
			br=new BufferedReader(new FileReader("C:\\Users\\Sairaj Y\\Downloads\\New\\SYMTAB.txt"));
			...
			br.close();
			br=new BufferedReader(new FileReader("C:\\Users\\Sairaj Y\\Downloads\\New\\LITTAB.txt"));
			while((line=br.readLine())!=null)
			{
				String parts[]=line.split("\\s+");
	...
	public void generateCode(String filename) throws Exception
	{
		...
		BufferedWriter bw=new BufferedWriter(new FileWriter("C:\\Users\\Sairaj Y\\Downloads\\New\\PASS2.txt"));
		String line,code;
		while((line=br.readLine())!=null)
		{
			String parts[]=line.split("\\s+");
